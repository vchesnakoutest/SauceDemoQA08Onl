...
public class CartTests extends BaseTest{
    ...
    public void addProductToCartWithPageFactoryTest() {
        ...
        loginPageFactory.login(System.getProperty("username", PropertyReader.getProperty("username")), System.getenv().getOrDefault("password", PropertyReader.getProperty("password")));
